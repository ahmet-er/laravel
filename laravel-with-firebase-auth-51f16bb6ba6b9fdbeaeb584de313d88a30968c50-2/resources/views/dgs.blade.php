...
<img src="{{URL::asset('/images/logo.png')}}" alt="profile Pic" height="200" width="200">
 <h1 class="card-title">DGS Başvuru Formu</h1>
</div>
...
<form id="addUser" class="form-inline" method="POST" action="{{ route('dgsPDF') }}">
  {{ csrf_field() }}
...
<div class="form-group mx-sm-3 mb-2">
<label for="numara" class="sr-only">Öğrenci Numarasi</label>
<input id="numara" type="text" class="form-control" name="numara" placeholder="ÖĞRENCİ NUMARASI"
required autofocus>
</div>

<div class="form-group mx-sm-3 mb-2">
<label for="phonenum" class="sr-only">Phone Number</label>
<input id="phonenum" type="text" class="form-control" name="phonenum" placeholder="Telefon Numarası"
required autofocus>
</div>
...
<div class="card card-default">
<div class="card-body">
    <div class="card card-header bg-success">Dgs Başvuru Bilgileri</div>
</br>
<div class="form-group mx-sm-3 mb-2">

<input id="okul" type="text" class="form-control" name="okul" placeholder="Üniversite "
required autofocus>
</div>
<div class="form-group mx-sm-3 mb-2">
<select name="dgsfakülte" id="dgsfakülte" class="form-control">
                  <option value="" selected="selected">Fakültenizi Seçin</option>
                </select>
                </div>

                <div class="form-group mx-sm-3 mb-2">
                <select name="dgsbölüm" id="dgsbölüm" class="form-control">
                  <option value="" selected="selected">Bölümünüzü Seçin</option>
                </select>
                <br><br>
</div>
...
var lastIndex = 0;
// Get Data
firebase.database().ref('Dgs/').on('value', function (snapshot) {
...
var okul = values[7].value;
var dgsfakülte = values[8].value;
var dgsbölüm = values[9].value;
var userID = lastIndex + 1;

console.log(values);
firebase.database().ref('Dgs/' + userID).set({
name: name,
email: email,
address: address,
phonenum: phonenum,
