...
<input id="name" type="text" class="form-control" name="name" placeholder="ADI SOYADI"
required autofocus>
</div>
<div class="form-group mx-sm-3 mb-2">
<label for="email" class="sr-only">Email</label>
<input id="email" type="email" class="form-control" name="email" placeholder="E-POSTA ADRESİ"
required autofocus>
</div>
<div class="form-group mx-sm-3 mb-2">
<label for="email" class="sr-only">Email</label>
<input id="tc" type="text" class="form-control" name="tc" placeholder="T.C. KİMLİK NO"
required autofocus>
</div>
<div class="form-group mx-sm-3 mb-2">
<label for="email" class="sr-only">Email</label>
<input id="dogumtarih" type="text" class="form-control" name="dogumtarih" placeholder="DOĞUM TARİHİ  "
required autofocus>
</div>

<div class="form-group mx-sm-3 mb-2">
<label for="adress" class="sr-only">Adress</label>
<input id="adress" type="text" class="form-control" name="adress" placeholder="TEBLİGAT ADRES "
required autofocus>
</div>
<div class="form-group mx-sm-3 mb-2">
<label for="phonenum" class="sr-only">Phone Number</label>
<input id="phonenum" type="number" class="form-control" name="phonenum" placeholder="TELEFON (GSM)"
required autofocus>
</div>
...
<div class="form-group mx-sm-3 mb-2">
<label for="phonenum" class="sr-only">Phone Number</label>
<input id="basvurutürü" type="text" class="form-control" name="phonenum" placeholder="BAŞVURU TÜRÜNÜZ"
required autofocus>
</div>
</div>
...
<input id="üniversite" type="text" class="form-control" name="üniversite" placeholder="HALEN KAYITLI OLDUĞU ÜNİVERSİTE "
required autofocus>
</div>
  <div class="form-group mx-sm-3 mb-2">
    <input id="fakülte" type="text" class="form-control" name="fakülte" placeholder="HALEN KAYITLI OLDUĞU FAKÜLTE / YÜKSEKOKUL"
    required autofocus>
  </div>
  <div class="form-group mx-sm-3 mb-2">
    <input id="bölüm" type="text" class="form-control" name="bölüm" placeholder="HALEN KAYITLI OLDUĞU BÖLÜM / PROGRAM	"
    required autofocus>
  </div>
  <div class="form-group mx-sm-3 mb-2">
