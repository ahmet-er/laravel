          ...
          <div class='card'>
            <div class="card text-center">
              ...
              <div class="card-body">
                ...
                <h1 class="card-title">Yaz Okulu Başvuru Formu</h1>
              </div>
            ...
            <div class="card card-default">
              <div class="card-body">
                ...
                <form id="addUser" class="form-inline" action="{{ route('yazokuluPDF') }}" method="POST">
                  {{ csrf_field() }}
                  ...
                  <div class="form-group mx-sm-3 mb-2">
                    ...
                    <input id="phonenum" type="text" class="form-control" name="phonenum" placeholder="Telefon Numarası"> <div class="form-group mx-sm-3 mb-2">
                    <label for="phonenum" class="sr-only">Öğrenci No</label>
                    <input id="studentnumber" type="text" class="form-control" name="studentnumber" placeholder="Öğrenci Numarası" required autofocus>
                  </div>
              </div>
            </div>
            <div class="card">
            ...
            <div class="card">
              ...
              <div class="card body">
                <div class="card card-header bg-success">Yaz Okulu Başvuru Bilgileri</div>
    </br> 
                </br>
                <div class="form-group mx-sm-3 mb-2">
                  <label for="name" class="sr-only">Ders Alınmak İstenen Fakülte</label>
                  <input id="yazfakülte" type="text" class="form-control" name="yazfakülte" placeholder="Ders Alınmak İstenen Fakülte" required autofocus>
                </div>
                <div class="form-group mx-sm-3 mb-2">
                  <label for="email" class="sr-only">Ders Alınmak İstenen Bölüm</label>
                  <input id="yazbölüm" type="text" class="form-control" name="yazbölüm" placeholder="Ders Alınmak İstenen Bölüm" required autofocus>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="card body">
                <div class="card card-header bg-success">Alınmak İstenen Dersler</div>
                </br>
    </br>
                <div class="form-group mx-sm-3 mb-2">
                  <label for="name" class="sr-only">Ders Alınmak İstenen Fakülte</label>
                  <input id="ders1" type="text" class="form-control" name="ders1" placeholder="Ders-1" required autofocus>
                </div>
                <div class="form-group mx-sm-3 mb-2">
                  <label for="email" class="sr-only">Ders Alınmak İstenen Bölüm</label>
                  <input id="ders2" type="text" class="form-control" name="ders2" placeholder="Ders-2">
                </div>
                <div class="form-group mx-sm-3 mb-2">
                  <label for="email" class="sr-only">Ders Alınmak İstenen Bölüm</label>
                  <input id="ders3" type="text" class="form-control" name="ders3" placeholder="Ders-3">
                </div>
                <div class="form-group mx-sm-3 mb-2">
                  <label for="email" class="sr-only">Ders Alınmak İstenen Bölüm</label>
                  <input id="ders4" type="text" class="form-control" name="ders4" placeholder="Ders-4">
                </div>
                <div class="form-group mx-sm-3 mb-2">
                  <label for="email" class="sr-only">Ders Alınmak İstenen Bölüm</label>
                  <input id="ders5" type="text" class="form-control" name="ders5" placeholder="Ders-5">
                </div>
              </div>
            </div>
            ...
            <button id="submitUser" type="button" class="btn btn-dark mb-2">Firebase</button>
...
firebase.initializeApp(firebaseConfig);
      ...
      <script>
        ...
        var lastIndex = 0;
        // Get Data
        firebase.database().ref('YazOkulu/').on('value', function(snapshot) {
        ...
        $('#submitUser').on('click', function() {
          ...
          var fakülte = values[4].value;
          var bölüm = values[5].value;
          var yazfakülte = values[6].value;
          var yazbölüm = values[7].value;
          var ders1 = values[8].value;
          var ders2 = values[9].value;
          var ders3 = values[10].value;
          var ders4 = values[11].value;
          var ders5 = values[12].value;
          var userID = lastIndex + 1;
          console.log(values);
          firebase.database().ref('YazOkulu/' + userID).set({
            name: name,
            email: email,
            address: address,
            phonenum: phonenum,
        ...
        $('body').on('click', '.updateData', function() {
          ...
          firebase.database().ref('YazOkulu/' + updateID).on('value', function(snapshot) {
...
<input id="last_name" type="text" class="form-control" name="email" value="' + values.email + '" required autofocus>\
        ...
        $('.updateUser').on('click', function() {
          ...
          var updates = {};
          updates['/YazOkulu/' + updateID] = postData;
        ...
        $('.deleteRecord').on('click', function() {
          ...
          firebase.database().ref('YazOkulu/' + id).remove();
