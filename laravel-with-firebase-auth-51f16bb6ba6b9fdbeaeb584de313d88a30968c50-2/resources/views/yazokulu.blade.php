...
<div class="card">
  ...
  <div class="card body">
    ...
    <div class="form-group mx-sm-3 mb-2">
    <label for="name" class="sr-only">Fakülteniz</label>
    <input id="fakülte" type="text" class="form-control" name="fakülte" placeholder="Fakülteniz"
    required autofocus>
    </div>
    <div class="form-group mx-sm-3 mb-2">
    <label for="email" class="sr-only">Bölümünüz</label>
...
<div class="card">
  ...
  <div class="card body">
    ...
    <input id="yazfakülte" type="text" class="form-control" name="yazfakülte" placeholder="Ders Alınmak İstenen Fakülte"
    required autofocus>
    </div>
    <div class="form-group mx-sm-3 mb-2">
    <label for="email" class="sr-only">Ders Alınmak İstenen Bölüm</label>
    <input id="yazbölüm" type="text" class="form-control" name="yazbölüm" placeholder="Ders Alınmak İstenen Bölüm"
    required autofocus>
    </div>
  </div>
</div>
...
<div class="card">
  ...
  <div class="card body">
    ...
    <div class="form-group mx-sm-3 mb-2">
    <label for="name" class="sr-only">Ders Alınmak İstenen Fakülte</label>
    <input id="ders1" type="text" class="form-control" name="ders1" placeholder="Ders-1"
    required autofocus>
    </div>
    <div class="form-group mx-sm-3 mb-2">
    <label for="email" class="sr-only">Ders Alınmak İstenen Bölüm</label>
