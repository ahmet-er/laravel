...
<input id="dgsfakülte" type="text" class="form-control" name="dgsfakülte" placeholder="Fakülte "
required autofocus>
</div>
  <div class="form-group mx-sm-3 mb-2">
    <input id="dgsbölüm" type="text" class="form-control" name="dgsbölüm" placeholder="Bölüm"
    required autofocus>
  </div>
